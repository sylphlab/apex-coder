...
<template>
  ...
  >
    ...
    <div class="mb-6 text-center">
      <h1 class="text-3xl font-light mb-2 text-nordic-text-primary">
        Apex Coder
      </h1>
    ...
    >
      <div class="p-6">
        ...
        <div class="text-center mb-6">
          <div
            class="w-16 h-16 mx-auto rounded-full bg-blue-100 flex items-center justify-center mb-4"
          >
            <svg
          ...
          <h2 class="text-xl font-medium mb-2 text-nordic-text-primary">
            Welcome to Apex Coder
          </h2>
          <p class="text-nordic-text-secondary mb-2">
          ...
          <div
            ...
            class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-blue-100 text-blue-800 mb-2"
          >
          ...
          <div
            v-else
            class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-100 text-green-800 mb-2"
          >
    ...
    >
      ...
      <div class="flex flex-wrap justify-center gap-2">
        <span class="px-2 py-1 rounded-md bg-blue-100 text-blue-800 text-xs"
          >OpenAI</span
        >
        <span class="px-2 py-1 rounded-md bg-purple-100 text-purple-800 text-xs"
          >Anthropic</span
        >
        <span class="px-2 py-1 rounded-md bg-green-100 text-green-800 text-xs"
          >Google AI</span
        >
        <span class="px-2 py-1 rounded-md bg-gray-100 text-gray-800 text-xs"
          >Ollama</span
        >
        <span class="px-2 py-1 rounded-md bg-red-100 text-red-800 text-xs"
          >Mistral</span
        >
        <span class="px-2 py-1 rounded-md bg-yellow-100 text-yellow-800 text-xs"
          >+ More</span
        >
      </div>
    </div>
    ...
    <!-- Footer -->
    <div
      class="mt-6 text-center text-xs text-[var(--vscode-descriptionForeground,#7B88A1)]"
    >
