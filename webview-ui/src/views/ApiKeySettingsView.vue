...
const emit = defineEmits(["getConfigStatus", "changeSettings"]);
  ...
  <div class="flex flex-col h-full animate-nordic-fade-in">
    ...
    <div class="px-6 py-4 border-b border-nordic-bg-light">
      <div class="flex items-center justify-between">
        <h1 class="text-xl font-light text-nordic-text-primary">
          API Key Settings
        </h1>
      ...
      <div class="mt-4 relative">
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5 text-nordic-text-muted"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
    ...
    >
      ...
      <div
        v-if="isLoading"
        class="flex flex-col items-center justify-center h-full text-nordic-text-muted"
      >
        <div
          class="w-16 h-16 mb-4 rounded-full bg-nordic-bg-light flex items-center justify-center animate-pulse"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-8 w-8 text-nordic-text-muted"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
      ...
      >
        <div
          class="w-16 h-16 mb-4 rounded-full bg-nordic-error bg-opacity-10 flex items-center justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-8 w-8 text-nordic-error"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-16 w-16 mb-4 text-nordic-text-muted opacity-50"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
          <path
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-10 h-10 rounded-full bg-nordic-bg-light flex items-center justify-center mr-3"
                >
                  <span class="text-sm font-medium text-nordic-primary">{{
                    provider.name.charAt(0)
                  }}</span>
                </div>
                <div>
                  <h3 class="text-sm font-medium text-nordic-text-primary">
                    {{ provider.name }}
                  </h3>
              ...
              <div class="flex items-center">
                ...
                <div
                  ...
                  class="mr-3 w-6 h-6 rounded-full bg-nordic-success bg-opacity-20 flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4 text-nordic-success"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                ...
                <div
                  v-else-if="isProviderError(provider.id)"
                  class="mr-3 w-6 h-6 rounded-full bg-nordic-error bg-opacity-20 flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4 text-nordic-error"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                ...
                <div
                  v-else
                  class="mr-3 w-6 h-6 rounded-full bg-nordic-bg flex items-center justify-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4 text-nordic-text-muted"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
