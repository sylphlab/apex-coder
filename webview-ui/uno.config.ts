...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "btn-nordic":
      "py-2.5 px-4 rounded-lg transition-all duration-200 font-medium text-sm focus:outline-none",
    "btn-nordic-primary":
      "btn-nordic bg-nordic-primary text-[var(--vscode-button-foreground,white)] hover:bg-opacity-90 focus:ring-2 focus:ring-nordic-primary focus:ring-opacity-50",
    "btn-nordic-secondary":
      "btn-nordic bg-nordic-secondary text-[var(--vscode-button-secondaryForeground,white)] hover:bg-opacity-90 focus:ring-2 focus:ring-nordic-secondary focus:ring-opacity-50",
    "btn-nordic-ghost":
      "btn-nordic bg-transparent hover:bg-nordic-bg-light text-nordic-text-primary",

    // Card shortcuts - using VS Code editor background with border for better visibility
    "card-nordic":
      "bg-[var(--vscode-editor-background,white)] border border-[var(--vscode-panel-border,#D8DEE9)] rounded-xl shadow-nordic p-5 transition-all duration-200",
    "card-nordic-hover": "card-nordic hover:shadow-nordic-md",

    // Input shortcuts
    "input-nordic":
      "w-full py-2.5 px-3.5 rounded-lg bg-[var(--vscode-input-background,white)] text-[var(--vscode-input-foreground,black)] border border-[var(--vscode-input-border,#D8DEE9)] focus:outline-none focus:ring-2 focus:ring-nordic-primary focus:ring-opacity-50 transition-all duration-200",
